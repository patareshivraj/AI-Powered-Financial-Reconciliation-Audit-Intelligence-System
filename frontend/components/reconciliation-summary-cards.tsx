    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full">
      ...
      <div className="p-5 bg-black/40 border border-white/[0.05] rounded-2xl flex flex-col justify-between space-y-3 shadow-inner hover:border-white/10 transition-all group">
        <div className="flex items-center justify-between text-neutral-400">
          <span className="text-xs font-bold uppercase tracking-widest text-neutral-500 font-sans">Match Efficiency Rate</span>
      ...
      <div className="p-5 bg-black/40 border border-white/[0.05] rounded-2xl flex flex-col justify-between space-y-3 shadow-inner hover:border-white/10 transition-all group">
        <div className="flex items-center justify-between text-neutral-400">
          <span className="text-xs font-bold uppercase tracking-widest text-neutral-500 font-sans">Reconciled Volume</span>
      ...
      <div className="p-5 bg-black/40 border border-white/[0.05] rounded-2xl flex flex-col justify-between space-y-3 shadow-inner hover:border-white/10 transition-all group">
        <div className="flex items-center justify-between text-neutral-400">
          <span className="text-xs font-bold uppercase tracking-widest text-neutral-500 font-sans">Discrepancy Volume</span>
        ...
        <div>
          ...
          <p className="text-xs text-neutral-500 mt-2 flex items-center gap-1.5 uppercase tracking-wide">
      ...
      <div className="p-5 bg-black/40 border border-white/[0.05] rounded-2xl flex flex-col justify-between space-y-3 shadow-inner hover:border-white/10 transition-all group">
        <div className="flex items-center justify-between text-neutral-400">
          <span className="text-xs font-bold uppercase tracking-widest text-neutral-500 font-sans">Composition</span>
        ...
        <div className="space-y-1.5">
          ...
          {summary.duplicate_count > 0 && (
            <div className="flex justify-between items-center text-xs text-orange-400/80 pt-1">
